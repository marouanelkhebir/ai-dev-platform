...
public class DockerSandboxManager implements SandboxManager {
    ...
    private static final String LABEL_PLATFORM = "com.company.aidev";
    private static final String LABEL_WORKFLOW = "com.company.aidev.workflow";
    private static final String LABEL_TICKET = "com.company.aidev.ticket";
    ...
    public DockerSandboxManager(SandboxProperties properties, CommandGuard commandGuard, PlatformMetrics metrics) {
    ...
    public Sandbox createSandbox(UUID workflowId, String jiraTicket) {
        ...
        List<String> env = properties.environment().entrySet().stream()
