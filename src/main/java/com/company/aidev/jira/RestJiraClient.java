...
import com.company.aidev.jira.model.JiraComment;
import com.company.aidev.jira.model.JiraIssue;
import com.company.aidev.jira.model.JiraIssueLink;
...
public class RestJiraClient implements JiraClient {
    ...
    public RestJiraClient(RestClient jiraRestClient, JiraProperties properties, ObjectMapper objectMapper) {
    ...
    public boolean transitionTo(String issueKey, String targetStatusName) {
        ...
        try {
            restClient
                    ...
                    .retrieve()
                    .toBodilessEntity();
            log.info("Jira issue {} transitioned to {}", issueKey, targetStatusName);
            return true;
        } catch (RestClientResponseException e) {
            throw new JiraException(
