...
public class LlmAuditListener implements ChatModelListener {
    ...
    public void onResponse(ChatModelResponseContext context) {
        ...
        recorder.recordSuccess(workflowId, agent, model, durationMs, input, output, total, finishReason);
    ...
    public void onError(ChatModelErrorContext context) {
        ...
        recorder.recordFailure(workflowId, agent, model, durationMs, error);
