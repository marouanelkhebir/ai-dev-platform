...
import com.mel.aidev.workflow.WorkflowStateStore;
...
class WorkflowEventStreamIT {
    ...
    void setUp() {
        ...
        // The workflow row carries a mandatory foreign key to its project.
        ProjectEntity project = new ProjectEntity(PROJECT_ID, "Banque", "bank/customer-management");
    ...
    private WorkflowEntity givenWorkflow(String ticket) {
        return workflowRepository.save(
                new WorkflowEntity(UUID.randomUUID(), PROJECT_ID, ticket, "bank/customer-management", "main"));
    }
